...
// Selecionando pela classe das mensagens
...
// Selecionando o botão que altera o a mensagem
const changeMessageBtn = document.getElementById("btn-mudar-textos");
...
changeMessageBtn.addEventListener("click", function () {
    for(let i = 0; i<mensagem.length; i++) {
        mensagem[i].textContent = `O texto ${i+1} foi alterado com sucesso`;
    }
  });